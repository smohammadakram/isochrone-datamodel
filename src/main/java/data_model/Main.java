...
public class Main {
	...
	public static void main(final String[] args) {
		...
		case "1":
			...
			final File vdv = new File(args[1]);
		...
		case "4":
			...
			final GraphBuilder gb = new GraphBuilder(args[3], args[1], args[2], db);
			db.resetFile(args[1] + "/" + args[2] + "_street_nodes_import.sql");
			db.resetFile(args[1] + "/" + args[2] + "_street_edges_import.sql");
			final File f1 = new File(args[1] + "/" + args[2] + "_street_nodes_import.sql");
			final File f2 = new File(args[1] + "/" + args[2] + "_street_edges_import.sql");
	 ...
	 * @return
	 */
	public static ArrayList<Table> generateTables(final String city, final String db) {
