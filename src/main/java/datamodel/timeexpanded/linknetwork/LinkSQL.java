...
//		+ "\tFROM time_expanded.<city>_bus_to_ped_coords_locate l;";
	...
	public static final String UPDATE_NODE_DEGRESS = "UPDATE time_expanded.<city>_street_nodes AS s SET node_in_degree = tmp.in_d\n"
		+ "FROM (SELECT sn.node_id, count(edge_destination) AS in_d\n"
		+ "\tFROM time_expanded.<city>_street_nodes sn"
		+ "JOIN time_expanded.<city>_street_edges se\n"
