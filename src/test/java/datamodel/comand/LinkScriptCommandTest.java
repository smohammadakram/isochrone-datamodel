...
import datamodel.command.LinkScriptCommand;
...
public class LinkScriptCommandTest {
	...
	private static final String[] EXPECTED_FILENAMES = new String[] {
		TEST_PREFIX + "_link_network.sql"
	};

	@Test
	public void testCommand() {
		final ICommand cmd = new LinkScriptCommand(TestHelper.TEST_OUTPUT_SCRIPT, TestHelper.TEST_CITY);
		cmd.execute();
